...
<script>
	/* 폼값을 submit(전송)할 때 빈값에 대한 검증을 위한 JS함수
...
<body>
	<h3>파일 업로드(multiple속성 추가)</h3>
	<span style="color: red;">${ errorMessage }</span>
	<!-- 파일첨부를 위한 <form>태그 구성시 아래 2가지는 필수사항
	1. method속성은 반드시 post
	2. enctype속성은 'multipart/form-data'로 해야 한다.
		만약 get방식으로 설정하는 경우에는 파일이 전송되는 게 아니라 파일명만 전송되게 된다. -->
