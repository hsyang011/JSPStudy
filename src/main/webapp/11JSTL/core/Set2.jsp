...
<body>
	...
	<!-- 2개의 객체 중 0번인덱스를 출력한다. List이므로 인덱스로 접근할 수 있다. 차후
	forEach태그를 사용하면 2개의 객체 전체를 반복해서 출력할 수 있다. -->
	<ul>
	...
	<h4>Map컬렉션 이용하기</h4>
	<%
	/* Map의 key는 String타입, value는 Person타입으로 정의한 후 2개의 Person객체를
	저장한다. */
	...
	<!-- Map컬렉션이므로 key를 통해 접근하여 값을 출력한다. -->
	<ul>
