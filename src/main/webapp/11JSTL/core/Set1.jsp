...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- JSTL의 core태그를 사용하기 위한 지시어 선언. prefix는 접두어, uri는 태그를 지원하는
예약어가 들어간다. -->
...
<body>
<!-- set태그 : 변수를 선언할때 사용. JSP의 setAttribute()와 동일한 기능을 한다.
	...
	<!-- value에는 일반값, EL, 표현식을 모두 사용할 수 있다. 또한 태그 사이에 value를
	삽입할 수도 있다. -->
	...
	겹쳐지는 경우가 발생하게된다. 이때는 value를 싱글쿼테이션으로 감싸서 겹쳐지지않게
	처리해야한다. -->
	...
	<!-- 빈객체를 먼저 생성한 후 target, property를 통해 멤버변수의 값을 설정한다.
