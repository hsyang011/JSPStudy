...
따라서 수정페이지 자체에서도 작성자 본인이 압는지 확인하는 절차가 필요하다. */
dao.close();
%>
<!DOCTYPE html>
<html>
...
<!-- 수정페이지는 일반적으로 쓰기페이지를 복사해서 제작하게 되므로 action속성값을 반드시
수정해야 한다. 만약 수정하지 않으면 게시물이 추가되는 해프닝이 생기게 된다. -->
<form name="writeFrm" method="post" action="EditProcess.jsp"
      onsubmit="return validateForm(this);">
    <!-- 게시물의 일련번호를 서버로 전송하기 위해 hidden타입의 <input>태그가 반드시
