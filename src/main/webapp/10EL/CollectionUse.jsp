...
%>
<ul>
	<!-- String객체가 출력된다. ArrayList는 배열의 특성을 가지므로 인덱스로 접근할 수
	있다. -->
	<li>0번째 요소 : ${ Ocean[0] }</li>
	<!-- Person객체를 출력한다. 멤버변수명을 통해 getter()를 호출하여 출력한다. 만약
	getter()를 정의하지 않으면 에러가 발생한다. -->
	<li>1번째 요소 : ${ Ocean[1].name }, ${ Ocean[1].age }</li>
	<!-- 2번인덱스에는 아무런 값도 없으므로 출력되지 않는다. Java라면 예외가 발생하겠지만,
	EL에서는 예외가 발생하지 않는다. -->
...
<ul>
	...
	<!-- EL식 앞에 \(역슬래쉬)를 붙이면 주석이 된다. 단 코드가 숨겨지는 것은 아니고
	코드가 그대로 화면에 출력된다. -->
</ul>
</body>
</html>