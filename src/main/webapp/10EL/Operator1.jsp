...
<body>
    ...
    <!-- Tomcat8부터는 EL에서 변수할당을 할 수 있다. 하지만 변수할당과 동시에 출력되므로,
    할당문 뒤에 ;''을 붙여줘야 출력되지 않는다. 즉, EL에서 변수할당은 거의 사용되지 않는다. -->
    ...
    num1 - num2 : ${ num1 - num2 } <br />
    num1 * num2 : ${ num1 * num2 } <br />
    <!-- 나눗셈에는 /와 div연산자를 사용할 수 있다. 또한 자동형변환이 적용되므로 정수끼리의
    연산에서 실수의 결과가 나올 수 있다. -->
    ...
    <!--  
		...
		== : eq(EQual)
		!= : ne(Not Equal)
	EL에서는 Java에서 사용하던 기본적인 비교연산자와 문자형태의 연산자 두가지 모두 사용할 수
	있다.
    -->
    <h3>비교 연산자</h3>
